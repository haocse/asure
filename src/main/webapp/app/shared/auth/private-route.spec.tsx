...
describe('hasAnyAuthority', () => {
  ...
  it('Should return false when authorities is valid and hasAnyAuthorities does not contain an authority', () => {
    ...
    expect(hasAnyAuthority([AUTHORITIES.USER, AUTHORITIES.ADMIN], ['ROLE_STUDENT'])).toEqual(false);
    expect(hasAnyAuthority([AUTHORITIES.USER, AUTHORITIES.ADMIN], ['ROLESTUDENT', 'ROLEADMIN'])).toEqual(false);
  });
});
